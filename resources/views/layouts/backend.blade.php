...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/')}}" href="{{asset('assets/backend/images/logos/favicon.')}}" />
  ...
  <!-- menambah wadah style dan akan dipanggil  -->
  @yield('styles')
</head>
...
<body>
  ...
  <!-- Preloader -->
  <div class="preloader">
    <img src="{{asset('assets/backend/images/logos/favicon.ico')}}" alt="loader" class="lds-ripple img-fluid" />
  </div>
  <div id="main-wrapper">
    <!-- Sidebar Start -->
        ...
        <ul class="mb-0">
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{asset('assets/backend/images/products/product-1.')}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{asset('assets/backend/images/products/product-2.')}}'" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
          ...
          <li class="pb-7">
            <div class="d-flex align-items-center">
              <img src="{{asset('assets/backend/images/products/product-3.')}}'" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="modernize-img" />
              <div>
                <h6 class="mb-1">Supreme toys cooker</h6>
                <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                <div class="d-flex align-items-center justify-content-between mt-2">
