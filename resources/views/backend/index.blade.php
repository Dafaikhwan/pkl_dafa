              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center mb-7 pb-2">
                    <div class="me-3 pe-1">
                      <img src="{{asset('assets/images/profile/user-2.jpg" cla')}}ss="shadow-warning rounded-2" alt="modernize-img" width="72" height="72" />
                    </div>
                    <div>
                    ...
                    <ul class="hstack mb-0">
                      <li class="ms-n8">
                        <a href="javascript:void(0)" class="me-1">
                          <img src="{{asset('assets/images/profile/user-2.jpg" cla')}}ss="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
                        </a>
                      </li>
                      <li class="ms-n8">
                        <a href="javascript:void(0)" class="me-1">
                          <img src="{{asset('assets/images/profile/user-3.jpg" cla')}}ss="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
                        </a>
                      </li>
                      <li class="ms-n8">
                        <a href="javascript:void(0)" class="me-1">
                          <img src="{{asset('assets/images/profile/user-4.jpg" cla')}}ss="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
                        </a>
                      </li>
                      <li class="ms-n8">
                        <a href="javascript:void(0)" class="me-1">
                          <img src="{{asset('assets/images/profile/user-5.jpg" cla')}}ss="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
                        </a>
                      </li>
                    </ul>
              ...
              <div class="card text-bg-primary border-0 w-100">
                <div class="card-body pb-0">
                  ...
                  <div class="text-center mt-3">
                    <img src="{{asset('assets/images/backgrounds/piggy.png" ')}}class="img-fluid" alt="modernize-img" />
                  </div>
                </div>
                      ...
                      <tbody class="border-top">
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('assets/images/profile/user-3.jpg" cla')}}ss="rounded-circle" width="40" height="40" alt="modernize-img" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('assets/images/profile/user-5.jpg" cla')}}ss="rounded-circle" width="40" height="40" alt="modernize-img" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('assets/images/profile/user-6.jpg" cla')}}ss="rounded-circle" width="40" height="40" alt="modernize-img" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('assets/images/profile/user-7.jpg" cla')}}ss="rounded-circle" width="40" height="40" alt="modernize-img" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="border-0 ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('assets/images/profile/user-8.jpg" cla')}}ss="rounded-circle" width="40" height="40" alt="modernize-img" />
                              </div>
                              <div>
